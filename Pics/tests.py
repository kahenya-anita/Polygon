...
class CategoryTest(TestCase):
    ...
    def test_category_instance(self):
        ...
        '''
        self.assertTrue(isinstance(self.destinations, Category))
    ...
    def test_delete_category(self):
        ...
        self.destinations.delete_category()
...
class ImageTestClass(TestCase):
    ...
    def test_save_image(self):
        ...
        #test_image.seek(0)
        self.test = Image(photo = test_image.name, name ='test', description = 'test image', category= self.destinations, location= self.nakuru )
    ...
    def test_update_image(self):
        ...
        self.test2 = Image(photo = test_image2.name, name ='test', description = 'test image', category= self.destinations, location= self.nakuru )
    ...
    def test_search_image_by_category(self):
        ...
        self.test = Image(photo = test_image.name, name ='test', description = 'test image', category= self.destinations, location= self.nakuru )
        self.test.save_image()
        images = Image.search_image("destinations")
        self.assertTrue(len(images) > 0)
    ...
    def test_search_location(self):
        ...
        self.test = Image(photo = test_image.name, name ='test', description = 'test image', category= self.destinations, location= self.nakuru )
        self.test.save_image()
        images = Image.filter_by_location("Nakuru")
        self.assertTrue(len(images) > 0)
